...
public class ListaEncadeadaAD {
    ...
    private NoAD pegaUltimoElemento() {
    ...
    public boolean insereUltimo(Integer i) {
        ...
        NoAD ultimoElemento = pegaUltimoElemento();
        NoAD novoDado = new NoAD(i);

        ultimoElemento.setaProximo(novoDado);
        novoDado.setaAnterior(ultimoElemento);
        return inserido;
    }
    ...
    public NoAD removeUltimo() {
        ...
        NoAD auxiliar = pegaUltimoElemento();
